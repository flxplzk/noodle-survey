...
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey 2 Description',NULL,-1,'OPEN','Test Survey 3 Title',-6, 'TIME');
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey 2 Private',NULL,-1,'PRIVATE','Test Survey 4 Title',-16, 'TIME');
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey Description',NULL,-1,'OPEN','Test Survey 5 Title',-17, 'TIME_RANGE');
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey 2 Description',NULL,-3,'CLOSED','Test Survey 6 Title',-18, 'DATE_RANGE');
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey 2 Description',NULL,-3,'PRIVATE','Test Survey 7 Title',-19, 'TIME');
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey 2 Private',NULL,-2,'PRIVATE','Test Survey 8 Title',-20, 'TIME');
