...
insert into survey (creation_date,description,event_id,initiator_id,survey_status,title,id,SURVEY_TYPE) values (CURRENT_DATE ,'Test Survey 2 Private',NULL,-1,'PRIVATE','Test Survey 2 Title',-16, 'TIME');
